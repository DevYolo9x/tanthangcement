...
//question module
use App\Http\Controllers\question\backend\QuestionController;
use App\Http\Controllers\question\backend\CategoryController as BackendQuestionCategoryController;
//product module
...
//CHuyên gia
use App\Http\Controllers\expert\backend\ExpertController;
//user ADMIN
...
use App\Http\Controllers\examination\backend\ExaminationController;
// Bênh nhân
use App\Http\Controllers\patient\backend\PatientController;

// Đơn hàng của đại lý
use App\Http\Controllers\patient\backend\PatientOrderController;
...
use App\Http\Controllers\customer\backend\CustomerOrderController;
...
Route::group(['middleware' => 'locale'], function () {
    Route::group(['prefix' => env('APP_ADMIN'), 'middleware' => ['auth:web']], function () {
        ...
        Route::group(['prefix' => '/patients'], function () {
            Route::get('/index', [PatientController::class, 'index'])->name('patients.index')->middleware('can:patients_index');
            Route::get('/create', [PatientController::class, 'create'])->name('patients.create')->middleware('can:patients_create');
            Route::post('/store', [PatientController::class, 'store'])->name('patients.store')->middleware('can:patients_create');
            Route::post('/update/{id}', [PatientController::class, 'update'])->name('patients.update')->middleware('can:patients_edit');
            Route::get('/edit/{id}', [PatientController::class, 'edit'])->name('patients.edit')->middleware('can:patients_edit');
            Route::get('/destroy/{id}', [PatientController::class, 'destroy'])->name('patients.destroy')->middleware('can:patients_destroy');
        });

        // Đơn hàng của đại lý
        Route::group(['prefix' => '/patient-payments'], function () {
            Route::get('/index', [PatientOrderController::class, 'index'])->name('patient_payments.index')->middleware('can:patients_index');
            Route::get('/edit/{id}', [PatientOrderController::class, 'edit'])->name('patient_payments.edit')->middleware('can:patients_edit');
        });

        Route::group(['prefix' => '/patients-log'], function () {
            Route::get('/', [PatientController::class, 'log'])->name('patients.log');
        });
        ...
        Route::group(['prefix' => '/category-products'], function () {
            ...
            Route::post('/update-view', [CategoryController::class, 'update_view'])->name('category_products.update_view')->middleware('can:category_products_edit');
        });
        //sản phẩm
        Route::group(['prefix' => '/products'], function () {
            ...
            Route::get('/imports', [ProductController::class, 'import'])->name('products.import')->middleware('can:products_index');
        ...
        //danh mục question
        Route::group(['prefix' => '/category-questions'], function () {
            Route::get('/index', [BackendQuestionCategoryController::class, 'index'])->name('category_questions.index')->middleware('can:category_questions_index');
            Route::get('/create', [BackendQuestionCategoryController::class, 'create'])->name('category_questions.create')->middleware('can:category_questions_create');
            Route::post('/store', [BackendQuestionCategoryController::class, 'store'])->name('category_questions.store')->middleware('can:category_questions_create');
            Route::get('/edit/{id}', [BackendQuestionCategoryController::class, 'edit'])->name('category_questions.edit')->middleware('can:category_questions_edit');
            Route::post('/update/{id}', [BackendQuestionCategoryController::class, 'update'])->name('category_questions.update')->middleware('can:category_questions_edit');
            Route::get('/destroy/{id}', [BackendQuestionCategoryController::class, 'destroy'])->name('category_questions.destroy')->middleware('can:category_questions_destroy');
        });
        //danh sách article
        Route::group(['prefix' => '/questions'], function () {
            ...
            Route::get('/destroy/{id}', [QuestionController::class, 'destroy'])->name('questions.destroy')->middleware('can:questions_destroy');
            Route::post('/select2', [QuestionController::class, 'select2']);
        });
        
        //danh sách Chuyên gia
        Route::group(['prefix' => '/experts'], function () {
            Route::get('/index', [ExpertController::class, 'index'])->name('experts.index')->middleware('can:experts_index');
            Route::get('/create', [ExpertController::class, 'create'])->name('experts.create')->middleware('can:experts_create');
            Route::post('/store', [ExpertController::class, 'store'])->name('experts.store');
            Route::get('/edit/{id}', [ExpertController::class, 'edit'])->name('experts.edit')->middleware('can:experts_edit');
            Route::post('/update/{id}', [ExpertController::class, 'update'])->name('experts.update')->middleware('can:experts_edit');
            Route::get('/destroy/{id}', [ExpertController::class, 'destroy'])->name('experts.destroy')->middleware('can:experts_destroy');
            Route::post('/select2', [ExpertController::class, 'select2']);
        });
        //danh mục media
        ...
        Route::group(['prefix' => '/agency'], function () {
            Route::get('/index', [ContactController::class, 'agency'])->name('contacts.agency')->middleware('can:contacts_index');
        });
        Route::group(['prefix' => '/register'], function () {
            Route::get('/index', [ContactController::class, 'register'])->name('contacts.register')->middleware('can:contacts_index');
        });
        Route::group(['prefix' => '/schedule-sampling'], function () {
            Route::get('/index', [ContactController::class, 'scheduleSampling'])->name('contacts.scheduleSampling')->middleware('can:contacts_index');
        });
        
        Route::group(['prefix' => '/schedule-an-appointment'], function () {
            Route::get('/index', [ContactController::class, 'scheduleAnAppointment'])->name('contacts.scheduleAnAppointment')->middleware('can:contacts_index');
        });
        Route::group(['prefix' => '/popup'], function () {
            Route::get('/popup', [ContactController::class, 'popup'])->name('contacts.popup')->middleware('can:contacts_index')->middleware('can:contacts_index');
        });
        Route::group(['prefix' => '/subscribers'], function () {
            Route::get('/index', [ContactController::class, 'subscribers'])->name('subscribers.index')->middleware('can:contacts_index');
        });
        ...
        Route::group(['prefix' => '/examinations'], function () {
            Route::get('index', [ExaminationController::class, 'index'])->name('examinations.index')->middleware('can:examinations_index');
            Route::get('create', [ExaminationController::class, 'create'])->name('examinations.create')->middleware('can:examinations_create');
            Route::post('create', [ExaminationController::class, 'store'])->name('examinations.store')->middleware('can:examinations_create');
            Route::get('edit/{id}', [ExaminationController::class, 'edit'])->name('examinations.edit')->middleware('can:examinations_edit');
            Route::post('update/{id}', [ExaminationController::class, 'update'])->name('examinations.update')->middleware('can:examinations_edit');
            Route::get('destroy', [ExaminationController::class, 'destroy'])->name('examinations.destroy')->middleware('can:examinations_destroy');
        });
        //order
        ...
        Route::group(['prefix' => '/customers'], function () {
            ...
            Route::post('/reset-password', [CustomerController::class, 'resetPassword'])->name('customers.resetPassword');
            //order
            ...
            Route::group(['prefix' => '/order'], function () {
                Route::get('/index/{customerID}', [CustomerOrderController::class, 'index'])->name('customerOrder.index')->middleware('can:customers_index');
                Route::get('create/{customerID}', [CustomerOrderController::class, 'create'])->name('customerOrder.create')->middleware('can:customers_create');
                Route::post('store/{customerID}', [CustomerOrderController::class, 'store'])->name('customerOrder.store')->middleware('can:customers_create');
                Route::get('edit/{customerID}/{orderID}', [CustomerOrderController::class, 'edit'])->name('customerOrder.edit')->middleware('can:customers_edit');
                Route::post('/update/{customerID}/{orderID}', [CustomerOrderController::class, 'update'])->name('customerOrder.update')->middleware('can:customers_edit');
            });
        });
        //customer social
