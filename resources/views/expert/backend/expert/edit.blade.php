...
@section('title')
<title>Cập nhập chuyên gia</title>
@endsection
@section('breadcrumb')
<?php
$array = array(
...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('experts.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
