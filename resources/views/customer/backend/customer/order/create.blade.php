...
@section('content')
    <div class="content">
        ...
        <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('customerOrder.store', ['customerID' => $customerID])}}" method="post" enctype="multipart/form-data" id="patientBuy">
                ...
                <div class="box p-5">
                    ...
                    <div>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control" value="{{ old('title') }}" id="validationTitle" name="title">
                            @error('title')
                    ...
                    <div class="">
                        <div class="text-right mt-5">
                            <button type="submit" class="btn btn-primary" id="addBuy">Thêm mới</button>
                        </div>
                    </div>
                </div>
            </div>
