...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('examinations.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        ...
                        <div class="">
                            ...
                            <?php echo Form::text('fullname', '', ['class' => 'form-control w-full']); ?>
                        </div>
                        
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Mã tra cứu</label>
                            <?php echo Form::text('examination_code', mt_rand(1000000000, 9999999999), ['class' => 'form-control w-full', '' => '']); ?>
                        </div>
                        
                        <div class="mt-3 hidden">
                            <label class="form-label text-base font-semibold">Đường dẫn</label>
                            <?php echo Form::text('slug', uniqid(), ['class' => 'form-control w-full', 'readonly' => 'readonly']); ?>
                        </div>

                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Ngày khám</label>
                            <?php echo Form::text('examination_date', '', ['class' => 'form-control w-full date', 'placeholder' => "--/--/----"]); ?>
                        </div>

                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Ngày nhận kết quả</label>
                            <?php echo Form::text('date_of_result', '', ['class' => 'form-control w-full date', 'placeholder' => "--/--/----"]); ?>
                        </div>

                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Ngày trả kết quả</label>
                            <?php echo Form::text('date_of_return', '', ['class' => 'form-control w-full date', 'placeholder' => "--/--/----"]); ?>
                        </div>
                        
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Mật khẩu</label>
                            <?php echo Form::text('examination_pass', mt_rand(1000, 9999), ['class' => 'form-control w-full']); ?>
                        </div>
                        
                        <div class="mt-3">
                            <label class="form-label text-base font-semibold">Trạng thái</label>
                            <?php echo Form::textarea('status', '', ['class' => 'form-control w-full']); ?>
                        </div>
        ...
        <div class=" col-span-12 lg:col-span-4">
            @include('components.image',['action' => 'create','name' => 'image','title'=> 'File đính kèm'])
