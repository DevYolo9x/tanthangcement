...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('category_articles.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-span-12 lg:col-span-4">
            ...
            <div class="mt-3 box p-5 pt-3 mt-3 mb-3">
                <div>
                    <label class="form-label text-base font-semibold">Loại giao diện trang chi tiết</label>
                    <?php echo Form::select('type', config('article')['catalogue_type'], $detail->type, ['class' => 'tom-select tom-select-custom w-full', 'data-placeholder' => "Loại danh mục"]); ?>
                </div>
            </div>
