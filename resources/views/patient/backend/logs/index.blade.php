...
@section('title')
<title>Logs bệnh nhân</title>
@endsection
@section('breadcrumb')
<?php
$array = array(
    [
        "title" => "Logs bệnh nhân",
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Bệnh nhân</th>
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td>
                            {{ isset($v->product) ? $v->product->title : '-' }}
                        </td>
                        <td>
                            {{ isset($v->patient) ? $v->patient->name : '-' }}
                        </td>
                        <td>
                            <b>
                                <?php 
                                ...
                                } else if(  !empty($v->customer_id) ) {
                                    $name = 'Customer: '.$v->customer->name;
