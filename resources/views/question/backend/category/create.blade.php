...
@section('title')
<title>Thêm mới danh mục câu hỏi</title>
@endsection
<!--START: breadcrumb -->
@section('breadcrumb')
<?php
...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('category_questions.store')}}" method="post" enctype="multipart/form-data">
