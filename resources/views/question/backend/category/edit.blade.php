...
@section('title')
<title>Cập nhập danh mục câu hỏi</title>
@endsection
<!--START: breadcrumb -->
@section('breadcrumb')
<?php
...
<div class="content">
    <div class=" flex items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">
            Cập nhập danh mục câu hỏi
        </h1>
    </div>
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('category_questions.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class=" col-span-12 lg:col-span-4">
            ...
            <div class="mt-3 box p-5 pt-3 mt-3 hidden">
                <div>
