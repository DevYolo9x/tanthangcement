    ...
    <div class="ibox mb-5 block-version" data-countattribute_catalogue="<?php echo count($htmlAttribute) - 1 ?>">
        <div class="ibox-title">
            <div class="grid grid-cols-3 justify-between text-base  items-center">
                <div class="col-span-2">
                    <h5>Tích chọn thông tin thuộc tính sẽ hiển thị phần tiện nghi,<br> Các mục còn lại sẽ hiển thị ở dưới mục giá</h5>
                    <small class="text-danger mt-3 hidden">Sản phẩm có các phiên bản dựa theo thuộc tính như kích thước hoặc màu sắc,...?(chọn tối đa 2 )</small>
                </div>
        ...
        <div class="ibox-content mt-5" style=" <?php echo (!empty($catalogue)) ? '' : 'display:none"' ?>">
            ...
            <div class="flex justify-between items-center bg-white" style="padding: 10px;">
                <label class="flex items-center cursor-pointer hide hidden">
            ...
            <div class="overflow-x-auto s_boxVariable hidden">
                        ...
                        <?php foreach ($title_version as $key => $value) { ?>
                            <div class="mb-2 dd3-content">
                                <div class="relative flex items-center">
                                    ...
                                    <img src="{{!empty($image_version[$key]) ? $image_version[$key] : url('images/404.png')}}" class="mr-3 s_imgAvatar" style="width: 45px;height: 45px;object-fit: cover;">
                                    ...
                                    @if(!empty($ids))
                                    <input type="hidden" name="ids[]" value="{{!empty($ids) ? $ids[$key] : 0}}">
                                    @endif
                                    <?php
                                    if ($errors->any()) { ?>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div class="avatar" style="cursor: pointer;flex:none">
                                                    <img src="{{!empty($image_version[$key]) ? $image_version[$key] : url('images/404.png')}}" class="img-thumbnail" style="width: 100px;height: 100px;object-fit: cover;">
                                                </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            <div class="form-switch">
                                                ...
                                                <input type="text" name="_stock_status[]" value="{{!empty($_stock_status[$key])?$_stock_status[$key]:0}}" class="hidden">
                                                <div class="form-check">
                                                    <input id="horizontal-form-{{$key}}" class="form-check-input selectStock" type="checkbox" value="1" @if(!empty($_stock_status[$key]==1)) checked @endif>
                                        ...
                                        <div class="showStock @if($_stock_status[$key]==0) hidden @endif">
                                            ...
                                            <div class="mt-3">
                                                <input type="text" name="_outstock_status[]" value="{{!empty($_outstock_status[$key])?$_outstock_status[$key]:''}}" class="hidden">
                                                <div class="form-check">
