...
$quantity = !empty(old('quantity')) ? old('quantity') : (!empty($detail->quantity) ? number_format($detail->quantity, '0', ',', '.') : '')
?>
...
<div class=" box p-5">
    ...
    <div class="mt-3 hidden">
        <label class="form-label text-base font-semibold  flex items-center">Số lượng</label>
        <?php echo Form::text('quantity', $quantity, ['class' => 'form-control int ', 'autocomplete' => 'off']);; ?>
    </div>
    <div class="mt-3">
...
<div class="box p-5 mt-3 space-y-3 ">
    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="">
            ...
            <div class="flex mt-3 items-center hidden">
                <div class="mr-1">
